class SubscriptionsController < ApplicationController
  ...
  def cancel_subscription
    ...
    # Find the subscription that needs to cancel
    current_subscription_plan = subscription.data.find { |o| o.plan.id == current_plan }

    if current_subscription_plan.blank?
      raise "subscription not found!"
    end
    # Delete it
    current_subscription_plan.delete
